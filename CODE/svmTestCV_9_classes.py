#  10-fold CV of SVM on the dataset with 9 classes
...
X1 = np.concatenate((class1, class4, class7, class10, class2, class3, class5, class6, class8, class9, class11, class12),
                    axis=3)
...
plt.ylabel('Num PCs')
plt.tight_layout()
plt.savefig('FIGURES/pca_param_select_svm_9cl.pdf')
...
with open(accSVM_9_fn, 'wb') as fp:
    pickle.dump(acc_mean, fp)

reports_9_fn = ('reportsSVM_9.p')
with open(reports_9_fn, 'wb') as fp:
    pickle.dump(reports, fp)

confusionMatrices_9_fn = ('confusionMatricesSVM_9.p')
...
with plt.style.context("default"):
    ...
    plt.grid()
    plt.savefig('FIGURES/accuracy_svm_10fold_9_classes.pdf')
...
plt.tight_layout()
plt.savefig('FIGURES/normCM_svm_10fold_9_classes.pdf')
